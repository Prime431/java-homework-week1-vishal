Feature: Nopcommerce Registration
  ...
  Scenario Outline: I should not able to register with invalid data on mandatory field (*) of registration page
    ...
    Examples:
      ...
      | Rohan      | bakshi    | ""               | 556897   | 456897           | please enter valid email                     |
      ...
      | Rohan      | bakshi    | bakshi@gmail.com | 456897   | 577584           | password and confirm password do not matched |
      | Rohan      | bakshi    | bakshi@gmail.com | 45689    | ""               | minimum 6 character passsword is required    |
  ...
  Scenario: I should be able to select any one radio button from Gender Lable of your Personal details section
    Given I am on Gender label of your personaldetail section
  ...
  Scenario: I should be able to check and uncheck the newsletter box on Options section
    ...
    And I again clcik on Newsboxletter Checkbox
  ...
  Scenario: I should be able to register with valid mandatory (*) field data on registration page
    ...
    Then I was able to register succcessfully
