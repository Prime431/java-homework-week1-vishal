Feature: Demo Nopcommerce's topmenu acceptance criteria
  ...
  Scenario: Verify that user can see 'Display' filter on Category page
    Given User is on Boooks Category page
    When User is on Books Category page
    And Check 'Display' filter is present
    Then 'Display' filter is available on Books Category page

  Scenario: Verify that user see 'Grid' tab on book Category page
    Given User is on Books Category page
    When User is on Books Category page
    And Check 'Grid' tab is present
    Then 'Grid' tab is available on Boook Category page
  ...
  Scenario: Verify that user can see 'Name: A to Z' selection is present in 'Sort by' filter
    ...
    Then 'Name: A to Z' selection is present in 'short by' filter

  Scenario: Verify that user can see 'Name: A to Z' is first option in 'Sort by' filter
    Given User is on Books Category page
    When User is on Books Category page
    And Click on 'Short by' Filter
    And Check that 'Name: A to Z' is first in order
    Then 'Name: A to Z' is first option in order

  Scenario: Verify that user can see 'Name: A to Z' filter is functioning as expectd (Note: Products are filtered in alphabetical order)
    Given User is on Books Category page
    When User is on Books Category page
    And Click on 'Sort by' filter
